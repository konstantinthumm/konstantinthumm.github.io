---
layout: single
title: "Moderne KPIs – was wirklich gemessen werden muss"
excerpt: "Kennzahlen helfen nur dann, wenn sie Entscheidungen verändern. Moderne KPIs richten sich nicht nach Aktivität, sondern nach Wirkung. Wie Organisationen den richtigen Fokus finden."
description: "Moderne KPIs erklären: Wie man Kennzahlen definiert, die Orientierung geben, wie man Leading und Lagging Indicators unterscheidet und warum weniger Zahlen oft mehr Klarheit bedeuten."
permalink: /moderne-kpi-was-messen/
author_profile: true
classes: ["wide","hero-tall","agile-value-series","avm-part-6"]
toc: true
toc_label: "Inhalt"
toc_sticky: true
...
1. Es wird gemessen, weil es möglich ist – nicht, weil es relevant ist.
2. KPIs werden als Ziel verstanden und nicht als Beobachtung.
3. Es fehlt ein Modell, das erklärt, wie die Kennzahl mit Wert verbunden ist.
...
- Lagging Indicators zeigen, was bereits geschehen ist.
  Beispiele: Zufriedenheit, Abschlusszahlen, Nutzungsstatistiken.

- Leading Indicators zeigen frühe Signale eines möglichen Trends.
  Beispiele: erste Rückmeldungen, Engagement, Nutzbarkeit, frühe Interaktionen.
...
Beispiel:
Eine digitale Anwendung hat sinkende Nutzungszahlen (Lagging).
Ein Leading Indicator hätte schon früher gezeigt, dass viele Menschen beim Formular an derselben Stelle abbrechen.

## 3. KPIs für Outcome statt Output

Moderne KPI-Arbeit richtet sich nicht nach Aktivität (Output), sondern nach Wirkung (Outcome).
Das bedeutet: Die Frage lautet nicht „Wie viel haben wir getan?“, sondern „Was hat sich verändert?“.
...
Output-KPI: Anzahl der eingegangenen Formulare
Outcome-KPI: Anteil der Anträge, die ohne Unterstützung abgeschlossen werden konnten
Leading Indicator: Rückmeldungen zur Verständlichkeit des Formulars

### Beispiel 2: Interne Zusammenarbeit

Output-KPI: Anzahl der Meetings
Outcome-KPI: wahrgenommene Klarheit nach Entscheidungen
Leading Indicator: Zeit bis zur ersten Umsetzung nach einem Beschluss

### Beispiel 3: Ehrenamt und Engagement

Output-KPI: Anzahl der Veranstaltungen
Outcome-KPI: wahrgenommene Wirksamkeit der Angebote
Leading Indicator: Rückmeldungen über Zugänglichkeit oder Barrieren
...
<div class="series-nav">
  <ul>
    ...
    <li>Teil 6: Moderne KPIs – was wirklich gemessen werden muss – aktuell hier</li>
