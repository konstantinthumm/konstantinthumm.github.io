...
<div class="kt-contact-card kt-download-card" role="region" aria-label="Downloads">
  <div class="kt-contact-card__content">
    ...
    <h3 class="kt-contact-card__title">Profil und Lebenslauf als PDF</h3>
...
<div class="kt-contact-card" role="region" aria-label="Kontakt und Vernetzung">
  <div class="kt-contact-card__content">
    <p class="kt-contact-card__eyebrow">Kontakt</p>
    <h3 class="kt-contact-card__title">Austausch ist willkommen</h3>
    <p class="kt-contact-card__text">
      Am besten erreichst du mich über LinkedIn oder per E-Mail.
    </p>
    <p class="kt-contact-card__links">
